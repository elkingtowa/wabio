#generate DNA finger print of org
#parse files -> find DNA chunks -> find primer seq in chunk -> find unique seq in primer segments -> 
#generate pyroprints -> compare pyroprints -> calculate pearson correlation -> graph
#forked from cal poly to apply to wider range of orgs
